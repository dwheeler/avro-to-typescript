...
class Compiler extends BaseCompiler_1.BaseCompiler {
    constructor(outputDir, logicalTypes, primitiveTypes) {
        super();
    ...
    async compile(data) {
        const classConverter = new ClassConverter_1.ClassConverter(this.logicalTypes, this.primitiveTypes);
    ...
    saveBaseAvroRecord() {
        ...
        if (!fs.existsSync(avroRecordPath)) {
            fs.writeFileSync(avroRecordPath, "export { BaseAvroRecord } from \"avro-to-typescript\";\n");
        }
    }
}
